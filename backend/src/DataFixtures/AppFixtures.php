...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $book1->setPages(96);
        $book1->setImage('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSfLtRjalUT26tXdZ3RHH8VRMzD0S0pT-tFDg&s');
        ...
        $book2->setPages(368);
        $book2->setImage('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSfLtRjalUT26tXdZ3RHH8VRMzD0S0pT-tFDg&s');
        ...
        $book3->setPages(320);
        $book3->setImage('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSfLtRjalUT26tXdZ3RHH8VRMzD0S0pT-tFDg&s');
